            ...
            <table class="table table-bordered table-striped m-b-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->Nama_c}}</td>
                        <td>
                        @if($item->statuscs=="Diajukan")
                        <a onClick="return confirm('Apakah Anda akan meng-ACC SIN?')" href="/accceraipolsek/{{ $item->id_izin}}"><i class='material-icons text-success sm'>offline_pin</i></a>
