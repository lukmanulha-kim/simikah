            ...
            <table class="table table-bordered table-striped m-b-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->Nama}}</td>
                        <td>{{ $item->Nama_c}}</td>
                        <td> @if($item->status_izinp=="Diajukan")Belum ACC @else Disetujui @endif</td>
                        <td>
                        @if($item->status_izinp=="Diajukan")
                        <a onClick="return confirm('Apakah Anda akan meng-ACC SIN?')" href="/accbagian/{{ $item->id_izin}}"><i class='material-icons text-success sm'>offline_pin</i></a>
